...
export function HeatDetailModal({ 
  ...
  return (
    ...
    >
      <div 
        className="bg-night border-2 border-neon-cyan rounded-2xl p-6 max-w-md mx-4 shadow-glow-cyan max-h-[80vh] overflow-y-auto"
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={onClose}
            className="text-steel hover:text-chrome text-2xl font-bold"
          >
            ✕
          </button>
        </div>
